...
*/
	...
	try{
            err = context.SHA1Input(s1.testarray,context.length(testarray));
            }catch(Exception e){
	...
	try{
        	err = context.SHA1Result(Message_Digest);
        }catch(Exception e){
